                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-12">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="{{ route('home') }}"><img src="{{ asset('frontend/images/logo.png') }}"
                                        alt="#"></a>
                            </div>
                            <!--/ End Logo -->
                                ...
                                <nav class="navbar navbar-default">
                                    <div class="navbar-collapse">
                                        ...
                                        <ul id="nav" class="nav menu navbar-nav">
                                            ...
                                            <li><a href="{{ route('uji') }}"><i class="fa fa-clone"></i>Tes Suara</a>
                                            </li>
                                            {{-- <li><a href="#"><i class="fa fa-bullhorn"></i>Events</a></li>
                                            <li><a href="#"><i class="fa fa-address-book"></i>Contact</a>
                                            </li> --}}
                                        </ul>
                                        <!-- End Main Menu -->
                                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <!-- Copyright -->
                            <div class="copyright">
                                <p>© Copyright Eduland 2019. Design & Development by <a
                                        href="http://themelamp.com">www.themelamp.com</a>, Theme Release By <a
                                        href="http://codeglim.com">www.codeglim.com</a></p>
                            </div>
                            <!--/ End Copyright -->
                        </div>
                    </div>
